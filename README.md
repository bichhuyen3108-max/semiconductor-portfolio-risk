...
VaR Formula
                <img src="https://latex.codecogs.com/svg.image?\Large%20VaR_{\alpha}%20=%20-Q_{\alpha}(R_t)" />
...
Student-t 분포를 활용하여 금융 데이터의 Fat-Tail 특성을 반영한 VaR 모델입니다
                    <img src="https://latex.codecogs.com/svg.image?\Large%20VaR_{\alpha}%20=%20\mu%20+%20\sigma%20\times%20t_{\alpha}" />
