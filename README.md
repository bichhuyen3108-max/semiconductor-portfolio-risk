...
VaR Formula
                <img src="https://latex.codecogs.com/svg.image?\Large&space;VaR_{\alpha}=\mu+\sigma\times t_{\alpha}" />
...
GARCH Equation
                <img src="https://latex.codecogs.com/svg.image?\sigma_t^2=\omega+\alpha\epsilon_{t-1}^2+\beta\sigma_{t-1}^2"/>

Value at Risk
                <img src="https://latex.codecogs.com/svg.image?VaR_{\alpha}=\mu+\sigma_{t|t-1}F^{-1}_{\alpha}"/>
...
<img src="results/figures/forecast_var_vs_realized_return.png" width="900">
...
<img src="results/figures/forecast_var_regime.png" width="900">
